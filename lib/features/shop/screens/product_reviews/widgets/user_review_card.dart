...
import 'package:doan/common/widgets/products/ratings/rating_indicator.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: TSizes.spaceBtwItems),
        const ReadMoreText(
          'The user interface of the app is quite intuitive. I was able to navigation and make purchases seamlessly. Great job!',
          trimLines: 2,
            ...
            child: Column(
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("H&H's Store", style: Theme.of(context).textTheme.titleMedium),
