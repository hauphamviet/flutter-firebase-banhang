class TFirebaseException implements Exception {
  ...
  const TFirebaseException(this.code);
  ...
  String get message {
    switch (code) {
      ...
      case 'invalid-credential':
        return 'The supplied credential is malformed oor has expired.';
      ...
      case 'invalid-app-credential':
        return 'The app credentials is invalid. Please provide a valid app credential';
      case 'user-mismatch':
      ...
      case 'missing-iframe-start':
        return 'The email template is missing th iframe start tag';
      case 'session-cookie-expired':
        return 'The Firebase session cookie has expired. Please sign in again';
      case 'uid-already-exists':
        return 'The provided users ID is already in use by another user';
      case 'web-storage-unsupported':
        return 'Web storage is not support of is disabled';
      case 'app-deleted':
