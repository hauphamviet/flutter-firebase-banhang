class TFirebaseAuthException implements Exception {
  ...
  String get message {
    switch (code) {
      ...
      case 'user-mismatch':
        return 'Them supplied credentials do not correspond to the previously signed in user';
      case 'account-exists-with-different-credential':
        return 'An account already exists with the sam email but different sign-in credentials';
